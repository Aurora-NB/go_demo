...
func main() {
	...
	client, err := elastic.NewClient(
		...
		elastic.SetURL("http://101.43.223.201:9200"),
	...
	info, code, err := client.Ping("http://101.43.223.201:9200").Do(context.Background())
	if err != nil {
		// Handle error
		panic(err)
	}
	...
	esversion, err := client.ElasticsearchVersion("http://101.43.223.201:9200")
	if err != nil {
		// Handle error
		panic(err)
	}
